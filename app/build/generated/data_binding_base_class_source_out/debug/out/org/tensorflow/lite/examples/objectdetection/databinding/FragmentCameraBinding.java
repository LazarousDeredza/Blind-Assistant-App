...
public final class FragmentCameraBinding implements ViewBinding {
  ...
  private FragmentCameraBinding(@NonNull LinearLayout rootView,
  ...
  public static FragmentCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CoordinatorLayout cameraContainer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentCameraBinding((LinearLayout) rootView, binding_bottomSheetLayout,
